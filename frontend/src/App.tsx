...
import OrderView from "./components/orderview/OrdersVeiw";
...
const SellerBankInfo = lazy(
  () => import("./pages/SellerBankInfo/SellerBankInfo")
);
...
const AdminOrder = lazy(
  () => import("../../admindashboard/src/Pages/AdminOrder")
);
      ...
      <CartProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path={PAGE_URLS.sellerPortal} element={<SellerPortal />}>
              <Route
                path="products"
                element={
