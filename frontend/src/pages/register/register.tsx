      ...
      <div>
        <div className="login-form-content1">
          <div className="input-group1">
            ...
            />
            <InputError
              input={usernameRef.current}
              name="اسم المستخدم"
              triggerValidate={triggerValidate}
            />
            {isUsernameTaken && (
              <ErrorMessage>تم استخدام هذا الاسم من قبل!</ErrorMessage>
            )}
          </div>
          ...
          <div className="input-group1">
            ...
            />
            {isEmailTaken && (
              <ErrorMessage>تم استخدام هذا البريد من قبل!</ErrorMessage>
            )}
          </div>
          ...
          <div className="input-group1">
            ...
            />
            <InputError
              input={phoneRef.current}
              name="رقم الجوال"
              value={phonevalue}
              triggerValidate={triggerValidate}
            />
            {isPhoneTaken && (
              <ErrorMessage>تم استخدام هذا الجوال من قبل!</ErrorMessage>
            )}
          </div>
